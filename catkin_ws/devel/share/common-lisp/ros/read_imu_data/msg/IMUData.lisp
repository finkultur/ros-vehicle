...
(cl:in-package read_imu_data-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <IMUData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IMUData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name read_imu_data-msg:<IMUData> is deprecated: use read_imu_data-msg:IMUData instead.")))

(cl:ensure-generic-function 'gyro0-val :lambda-list '(m))
(cl:defmethod gyro0-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader read_imu_data-msg:gyro0-val is deprecated.  Use read_imu_data-msg:gyro0 instead.")
  (gyro0 m))

(cl:ensure-generic-function 'gyro1-val :lambda-list '(m))
(cl:defmethod gyro1-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader read_imu_data-msg:gyro1-val is deprecated.  Use read_imu_data-msg:gyro1 instead.")
  (gyro1 m))

(cl:ensure-generic-function 'gyro2-val :lambda-list '(m))
(cl:defmethod gyro2-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader read_imu_data-msg:gyro2-val is deprecated.  Use read_imu_data-msg:gyro2 instead.")
  (gyro2 m))

(cl:ensure-generic-function 'acc0-val :lambda-list '(m))
(cl:defmethod acc0-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader read_imu_data-msg:acc0-val is deprecated.  Use read_imu_data-msg:acc0 instead.")
  (acc0 m))

(cl:ensure-generic-function 'acc1-val :lambda-list '(m))
(cl:defmethod acc1-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader read_imu_data-msg:acc1-val is deprecated.  Use read_imu_data-msg:acc1 instead.")
  (acc1 m))

(cl:ensure-generic-function 'acc2-val :lambda-list '(m))
(cl:defmethod acc2-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader read_imu_data-msg:acc2-val is deprecated.  Use read_imu_data-msg:acc2 instead.")
  (acc2 m))

(cl:ensure-generic-function 'mag0-val :lambda-list '(m))
(cl:defmethod mag0-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader read_imu_data-msg:mag0-val is deprecated.  Use read_imu_data-msg:mag0 instead.")
  (mag0 m))

(cl:ensure-generic-function 'mag1-val :lambda-list '(m))
(cl:defmethod mag1-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader read_imu_data-msg:mag1-val is deprecated.  Use read_imu_data-msg:mag1 instead.")
  (mag1 m))

(cl:ensure-generic-function 'mag2-val :lambda-list '(m))
(cl:defmethod mag2-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader read_imu_data-msg:mag2-val is deprecated.  Use read_imu_data-msg:mag2 instead.")
  (mag2 m))
